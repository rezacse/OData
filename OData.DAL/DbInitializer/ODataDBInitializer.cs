...
namespace OData.DAL.DbInitializer
{
    ...
    public class ODataDBInitializer : DropCreateDatabaseAlways<ODataDbContext>
    {
        protected override void Seed(ODataDbContext context)
        {
            // PressingDetail 
