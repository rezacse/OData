...
namespace OData.DAL.DbInitializer
{
    public class ODataDbContext : DbContext
    {
        ...
        {
            Database.SetInitializer(new ODataDBInitializer());
        ...
        public override int SaveChanges()
        {
            ...
            var modifiedOrAdderVinylRecords = ChangeTracker.Entries<VinylRecord>()
                .Where(e => e.State == EntityState.Added
                            || e.State == EntityState.Modified
                            || e.State == EntityState.Unchanged)
                .ToList();
            foreach (var vinylRecord in modifiedOrAdderVinylRecords)
            {
                ...
                foreach (var dynamicPropertyToSave in dynamicProperties)
                {
                    ...
                    var existingDynamicProperty = ChangeTracker.Entries<DynamicProperty>()
